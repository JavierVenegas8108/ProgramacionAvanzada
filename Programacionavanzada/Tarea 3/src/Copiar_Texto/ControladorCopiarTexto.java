...
public class ControladorCopiarTexto {
    private ModeloCopiarTexto modelo;
    private VistaCopiarTexto vista;

    public ControladorCopiarTexto(ModeloCopiarTexto modelo, VistaCopiarTexto vista) {
        this.modelo = modelo;
        this.vista = vista;
