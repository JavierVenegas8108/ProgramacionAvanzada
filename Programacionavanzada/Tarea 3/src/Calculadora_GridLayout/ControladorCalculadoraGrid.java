package Calculadora_GridLayout;
...
public class ControladorCalculadoraGrid {
    private ModeloCalculadoraGrid modelo;
    private VistaCalculadoraGrid vista;

    public ControladorCalculadoraGrid(ModeloCalculadoraGrid modelo, VistaCalculadoraGrid vista) {
        this.modelo = modelo;
        this.vista = vista;
