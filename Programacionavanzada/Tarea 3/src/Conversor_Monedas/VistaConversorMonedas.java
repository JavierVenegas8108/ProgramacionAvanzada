...
public class VistaConversorMonedas extends JFrame {
    ...
    private void inicializarComponentes() {
        ...
        gbc.gridwidth = 2;
        setCmbMonedaOrigen(new JComboBox<>());
        getCmbMonedaOrigen().setFont(new Font("Arial", Font.PLAIN, 14));
        panelCentral.add(getCmbMonedaOrigen(), gbc);
        ...
        gbc.gridwidth = 2;
        setCmbMonedaDestino(new JComboBox<>());
        getCmbMonedaDestino().setFont(new Font("Arial", Font.PLAIN, 14));
        panelCentral.add(getCmbMonedaDestino(), gbc);
    ...
    public void cargarMonedas(String[] monedas) {
        for (String moneda : monedas) {
            getCmbMonedaOrigen().addItem(moneda);
            getCmbMonedaDestino().addItem(moneda);
        }
        getCmbMonedaOrigen().setSelectedItem("USD");
        getCmbMonedaDestino().setSelectedItem("EUR");
    }
    ...
    public String getMonedaOrigen() {
        return (String) getCmbMonedaOrigen().getSelectedItem();
    }

    public String getMonedaDestino() {
        return (String) getCmbMonedaDestino().getSelectedItem();
    }
    ...
    public void intercambiarMonedas() {
        String temp = (String) getCmbMonedaOrigen().getSelectedItem();
        getCmbMonedaOrigen().setSelectedItem(getCmbMonedaDestino().getSelectedItem());
        getCmbMonedaDestino().setSelectedItem(temp);
    }
	...
	public JComboBox<String> getCmbMonedaOrigen() {
		return cmbMonedaOrigen;
	}

	public void setCmbMonedaOrigen(JComboBox<String> cmbMonedaOrigen) {
		this.cmbMonedaOrigen = cmbMonedaOrigen;
	}

	public JComboBox<String> getCmbMonedaDestino() {
		return cmbMonedaDestino;
	}

	public void setCmbMonedaDestino(JComboBox<String> cmbMonedaDestino) {
